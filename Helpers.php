...
class Checker
{
    ...
    {   
        ...
        if($count_1 !== 1) {
            $result[] = 'Слово ' . $word_1 . ' должно отличаться от вашего ровно на 1 символ!<br>Отличается на ' . $count_1;
        }

        if($count_2 !== 1) {
            $result[] = 'Слово ' . $word_2 . ' должно отличаться от вашего ровно на 1 символ!<br>Отличается на ' . $count_2;
        }
